...
<div class="flex flex-row gap-20 w-full items-center justify-between mx-40">
	<div class="flex flex-col gap-10 ml-20 p-10 justify-center items-center">
		<h1 class="tracking-wider text-accent font-extrabold p-4 text-[32px] uppercase">{currentLobby?.name}</h1>
		...
		<div class="flex flex-row gap-4">
			<div class="px-4 py-2 rounded-xl bg-secondaryBg uppercase font-mono">{currentLobby?.state}</div>
			<button class="bg-accent px-2 py-1 text-[12px] rounded-xl uppercase hover:brightness-75 duration-300 ease-in-out">Next state</button>
		</div>
	</div>
	<div class="flex flex-col gap-2 justify-center items-center">
		...
		<div class="px-4 py-2 rounded-xl bg-secondaryBg font-mono">2. CONFIGURING -> players joining</div>
