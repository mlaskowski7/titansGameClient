<script lang="ts">
	import { addFriend, type User } from "$lib";
...
<div class="flex flex-col gap-1">
    ...
    {#if isFriend}
        <button class="bg-red-600 w-40 mx-auto rounded-md hover:brightness-75 duration-300 ease-in-out mt-4" on:click={() => addNewFriend(currentUserId, friend)}>Remove Friend</button>
    {:else}
